...
export interface CoverGenerationModalProps {
...
export function CoverGenerationModal({
  ...
  characterId,
  onComplete,
}: CoverGenerationModalProps): JSX.Element {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Generate cover using the avatar endpoint with prompt and optional reference image
      // The endpoint supports prompt, referenceImageUrl, and imageType for custom generation
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title={t('characters:images.coverHeader', 'Generate Cover Image')}
      size="md"
    >
        ...
        {generatedImageUrl && (
          <div>
            ...
            <img
              ...
              alt={t('characters:images.coverHeader', 'Generated cover')}
      ...
      <div className="flex justify-end gap-2 mt-4">
        ...
        <Button
          ...
          disabled={isGenerating || isUploading || (!prompt && !sampleImage)}
        >
