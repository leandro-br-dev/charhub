...
export interface AvatarGenerationModalProps {
...
export function AvatarGenerationModal({
  ...
  characterId,
  onComplete,
}: AvatarGenerationModalProps): JSX.Element {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title={t('characters:images.avatarHeader', 'Generate Avatar')}
      size="md"
    >
        ...
        {generatedImageUrl && (
          <div>
            ...
            <img
              ...
              alt={t('characters:images.avatarHeader', 'Generated avatar')}
