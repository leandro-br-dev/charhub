...
const namespaces = ['common', 'home', 'login', 'signup', 'callback', 'dashboard', 'notFound', 'legal', 'characters', 'chat', 'imageGallery', 'story', 'navigation', 'profile', 'plans', 'welcome', 'analytics', 'adminScripts'];
