...
exports.seedVisualStyles = seedVisualStyles;
...
async function seedVisualStyles() {
    ...
    const animeCheckpoint = await prisma.styleCheckpoint.upsert({
        ...
        create: {
            ...
            modelType: prisma_1.ModelType.CHECKPOINT,
            config: {
    ...
    const animeLora = await prisma.styleLora.upsert({
        ...
        create: {
            ...
            modelType: prisma_1.ModelType.LORA_STYLE,
    ...
    const animeStyle = await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.ANIME },
        update: {},
        create: {
            style: prisma_1.VisualStyle.ANIME,
            name: 'Anime',
    ...
    const realisticStyle = await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.REALISTIC },
        update: {},
        create: {
            style: prisma_1.VisualStyle.REALISTIC,
            name: 'Realistic',
    ...
    const semiRealisticStyle = await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.SEMI_REALISTIC },
        update: {},
        create: {
            style: prisma_1.VisualStyle.SEMI_REALISTIC,
            name: 'Semi-Realistic',
    ...
    const cartoonStyle = await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.CARTOON },
        update: {},
        create: {
            style: prisma_1.VisualStyle.CARTOON,
            name: 'Cartoon',
    ...
    await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.MANGA },
        update: {},
        create: {
            style: prisma_1.VisualStyle.MANGA,
            name: 'Manga',
    ...
    // MANHWA Style
    await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.MANHWA },
        update: {},
        create: {
            style: prisma_1.VisualStyle.MANHWA,
            name: 'Manhwa',
    ...
    // COMIC Style
    await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.COMIC },
        update: {},
        create: {
            style: prisma_1.VisualStyle.COMIC,
            name: 'Comic',
    ...
    // CHIBI Style
    await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.CHIBI },
        update: {},
        create: {
            style: prisma_1.VisualStyle.CHIBI,
            name: 'Chibi',
    ...
    // PIXEL_ART Style
    await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.PIXEL_ART },
        update: {},
        create: {
            style: prisma_1.VisualStyle.PIXEL_ART,
            name: 'Pixel Art',
    ...
    // THREE_D Style
    await prisma.visualStyleConfig.upsert({
        where: { style: prisma_1.VisualStyle.THREE_D },
        update: {},
        create: {
            style: prisma_1.VisualStyle.THREE_D,
            name: '3D Rendered',
    ...
    await prisma.styleContentCheckpoint.upsert({
        where: {
            styleId_contentType: {
                styleId: animeStyle.id,
                contentType: prisma_1.ContentType.FURRY
            }
        },
        update: {},
        create: {
    ...
    await prisma.styleContentCheckpoint.upsert({
        where: {
            styleId_contentType: {
                styleId: animeStyle.id,
                contentType: prisma_1.ContentType.HENTAI
            }
        },
        update: {},
        create: {
...
//# sourceMappingURL=seedVisualStyles.js.map