...
import characterFiltersRoutes from './characterFilters';
...
import adminScriptsRoutes from './admin/scripts';
...
router.use('/character-filters', characterFiltersRoutes);
...
router.use('/admin/scripts', adminScriptsRoutes);
