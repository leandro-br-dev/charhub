...
export async function compileCharacterDataWithLLM(
  ...
  try {
    const compilationPrompt = [
      ...
      `  "gender": "string - MUST be one of: MALE, FEMALE, NON_BINARY, OTHER, UNKNOWN (uppercase, required)",`,
      `  "species": "string - Species name in English (e.g., human, elf, robot, furry, demon, angel, etc. - default: human)",`,
